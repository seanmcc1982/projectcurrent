...
class ScreensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create screen" do
    assert_difference('Screen.count') do
      post screens_url, params: { screen: { rows: @screen.rows, screenname: @screen.screenname, seating: @screen.seating, width: @screen.width } }
    end
  ...
  test "should update screen" do
    patch screen_url(@screen), params: { screen: { rows: @screen.rows, screenname: @screen.screenname, seating: @screen.seating, width: @screen.width } }
